...
export * from './models/cc.idb.model';

export class Email implements model.IEmailAddress {
    id?: number;
    contactId: number;
    type: string;
    email: string;
...
export class PhoneNumber implements model.IPhoneNumber {
    id?: number;
    contactId: number;
    type: string = null;
    phone: string = '';
...
/* This is a 'physical' class that is mapped to
    ...
    */
export class Contact implements model.IContact {
    ...
    emails: model.IEmailAddress[];
    phones: model.IPhoneNumber[];
...
export class Data implements model.IData {
    emails: Array<model.IEmailAddress> = [];
    phoneNumbers: Array<model.IPhoneNumber> = [];
    contacts: Array<model.IContact> = [];
}

export class DbContext extends Dexie {

    contacts: Dexie.Table<model.IContact, number>;
    emails: Dexie.Table<model.IEmailAddress, number>;
    phones: Dexie.Table<model.IPhoneNumber, number>;
